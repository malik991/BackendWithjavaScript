...
const uploadOnCloudinary = async (localFilePath) => {
  try {
    ...
    // when file uploaded to cloudinary successfullt than
    ...
    fs.unlinkSync(localFilePath); // unlinkSync is funtion which forcefully unling or delte the file from local server temp file
